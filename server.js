...
// V22.2 ANTI-SLEEP
app.get('/health', (req,res)=>{ res.status(200).send('OK HESAPLAMA V22.8 STABLE - '+new Date().toISOString()); });
...
server.listen(PORT, '0.0.0.0', ()=> console.log(`HESAPLAMA V22.8 STABLE - tum ozellikler - FINAL STABIL - port ${PORT} - PBKDF2 + sesli + reaksiyon + screenshot + panic2 + fakeNotif + blur + otoReconnect + cizim`));